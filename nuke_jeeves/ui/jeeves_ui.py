print '> importing nuke_jeeves.ui.jeeves_ui'
...
uiFile = os.path.join(core.resourcesRoot, 'vfx', 'pipeline', 'jeeves', '_jeeves', 'ui', 'templates', 'jeeves.ui')
uiFile = os.path.join(core.resourcesRoot, 'vfx', 'pipeline', 'jeeves_dev', 'nuke_jeeves', 'ui', 'templates', 'jeeves.ui')
uiFile = '/Users/elliott/Google Drive/pipeline/jeeves_dev/nuke_jeeves/ui/templates/jeeves.ui'
...
site_packages_OSX = '/Applications/Autodesk/maya2015/Maya.app/Contents/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages'										# Location of site-packages containing PySide and pysideuic and/or PyQt and SIP
