...
proc filter_compressed_list {dir compressed_list} {
  ...
  foreach f $compressed_list {
    ...
    if {[string first % $name] >= 0 && [regexp {.\.((avi)|(mov)|(autosave)|(nk)|(chan)|(3dt)|(2dt)|(txt)|(fbx)|(xml)|(ssf))$} [string tolower $name]]} {
...
proc drop_node {f} {
  ...
  switch $ext {
    ...
    ".obj" {
      ...
      ReadGeo2 -New file $f
      set newNode [stack 0]
      knob $newNode.read_texture_w_coord 0
