print '> importing maya_jeeves.importer'
...
class importer(object):
    def __init__(self, found_file):
        print '\t> maya_jeeves.importer'
        self.found_file = found_file
        self.import_type()
    
    def import_type(self):
        print '\t> maya_jeeves.importer.import_type'
    ...
    def maya_import(self):
        print '\t> maya_jeeves.importer.maya_import'
        print self.found_file
        
    
    def abc_add_namespaces(self):
        print '\t> maya_jeeves.importer.abc_add_namespaces'
    ...
    def abc_import(self):
        print '\t> maya_jeeves.importer.abc_import'
