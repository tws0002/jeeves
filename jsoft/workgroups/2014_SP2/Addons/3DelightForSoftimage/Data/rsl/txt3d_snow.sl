...
#ifndef __txt3d_snow_sl
#define __txt3d_snow_sl

#include "sib_texture_snow.sl"
#include "mib_bump_map.sl"
#include "mib_texture_remap.sl"

/*
	This is the more elaborate version of sib_texture_snow shader.
*/
/* Softimage 2013 */
void txt3d_snow(
	...
	output float o_result_a; )
{
	...
	if( i_alpha_output == true )
	{
		sib_texture_snow(
			coord,
			SIB_TEXTURE_SNOW_PARAMS_LIST_COPYALPHA,
			i_noise_type,
