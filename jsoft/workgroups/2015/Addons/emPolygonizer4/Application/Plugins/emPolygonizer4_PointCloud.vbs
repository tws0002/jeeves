' emPolygonizer4_PointCloudPlugin
...
function XSILoadPlugin( in_reg )
	...
	in_reg.Name = "emPolygonizer4_PointCloudPlugin"
	in_reg.Email = "info@mootzoid.com"
	in_reg.URL = "http://www.mootzoid.com/"
	in_reg.Major = 1
	in_reg.Minor = 0
	in_reg.Help = "http://www.mootzoid.com/wb/pages/documentation/empolygonizer4_redirect_TheCPSPointCloud.html"

	in_reg.RegisterProperty "emPolygonizer4_PointCloud"
...
function emPolygonizer4_PointCloud_Define( in_ctxt )
	...
	oCustomProperty.AddParameter2 "use",					siInt4,		2,		0,100,			0,100,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	...
	oCustomProperty.AddParameter2 "radius",					siFloat,	1,		0,100000,		0,2.5,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "radius_mulbypntsize",	siBool,		true,	,,,,						siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "falloff",				siFloat,	0.1,	0,100000,		0,5,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "falloffType",			siInt4,		3,		0,100,			0,4,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "falloff_mulbypntsize",	siBool,		true,	,,,,						siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	...
	oCustomProperty.AddParameter2 "color_baseG",			siDouble,	0.7,	-100000,100000,	0,1,		siClassifUnknown,	siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "color_baseB",			siDouble,	0.9,	-100000,100000,	0,1,		siClassifUnknown,	siPersistable OR siAnimatable OR siKeyable
	...
	oCustomProperty.AddParameter2 "LFself",					siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	...
	' tab "emFluid" stuff
	oCustomProperty.AddParameter2 "emF__plotAsCubes",			siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_use",					siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_srcStart",		siFloat,	200,	-1000000,1000000,	0,1500,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_srcEnd",		siFloat,	500,	-1000000,1000000,	0,1500,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_dstStart",		siFloat,	0,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_dstEnd",		siFloat,	1,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_clampStart",	siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_he_rescl_clampEnd",		siBool,		false,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_use",					siBool,		false,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_srcStart",		siFloat,	0.0001,	-1000000,1000000,	0,0.005,	siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_srcEnd",		siFloat,	0.0007,	-1000000,1000000,	0,0.005,	siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_dstStart",		siFloat,	0,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_dstEnd",		siFloat,	1,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_clampStart",	siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_wa_rescl_clampEnd",		siBool,		false,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_use",					siBool,		false,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_srcStart",		siFloat,	0,		-1000000,1000000,	0,10,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_srcEnd",		siFloat,	1,		-1000000,1000000,	0,10,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_dstStart",		siFloat,	0,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_dstEnd",		siFloat,	1,		-1000000,1000000,	0,2,		siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_clampStart",	siBool,		true,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	oCustomProperty.AddParameter2 "emF_de_rescl_clampEnd",		siBool,		false,	,,,,							siClassifTopo,		siPersistable OR siAnimatable OR siKeyable
	'
	...
	'
	emPolygonizer4_PointCloud_Define = true
end function
...
function myownDefineLayout( oLayout, LFprofile_height_overallfade, LFprofile_height_overallprofile, unused_ )
	...
	' get values of certain emFluid parameters
	dim ppgShowEmFluid
	dim ppgShowEmFluid_plotAsCubes
	dim ppgShowEmFluid_he
	dim ppgShowEmFluid_wa
	dim ppgShowEmFluid_de
	ppgShowEmFluid				= false
	ppgShowEmFluid_plotAsCubes	= false
	ppgShowEmFluid_he			= false
	ppgShowEmFluid_wa			= false
	ppgShowEmFluid_de			= false
	If TypeName( PPG ) <> "Empty" then
		if PPG.use.Value = 7 then
			ppgShowEmFluid = true
		end if
		if ppgShowEmFluid then
			ppgShowEmFluid_plotAsCubes	= PPG.emF__plotAsCubes.Value
			ppgShowEmFluid_he			= PPG.emF_he_use.Value
			ppgShowEmFluid_wa			= PPG.emF_wa_use.Value
			ppgShowEmFluid_de			= PPG.emF_de_use.Value
		end if
	end if
	...
	oLayout.AddTab "Main"
		...
		Dim lv7(7)
		lv7(0) = "Use Object's Center"
		lv7(1) = 0
		lv7(2) = "Use Points"
		lv7(3) = 1
		lv7(4) = "Use Points and Strands+LOD"
		lv7(5) = 2
		lv7(6) = "Use emFluid 3D Grids"
		lv7(7) = 7
		oLayout.AddEnumControl "use", lv7,							"Use", siControlCombo
		Dim lv9(9)
		if not ppgShowEmFluid then
			...
			oLayout.AddItem "emF__plotAsCubes",							"Plot as Cubes"
			oLayout.AddGroup "Size and Influence (Multipliers)"
				oLayout.AddItem "isofactor",							"Isofactor"
				if not ppgShowEmFluid_plotAsCubes then
					oLayout.AddItem "radius",								"Radius"
					oLayout.AddItem "falloff",								"Falloff"
					lv9(0) = "None"
					lv9(1) = 0
	...
	' tab "emFluid 3D Grids"
	if ppgShowEmFluid then
		oLayout.AddTab "emFluid 3D Grids"
			oLayout.AddGroup "Tools"
				oLayout.AddRow
					oLayout.AddSpacer 0,0
					oLayout.AddButton "iceLookForEmFluidGrids", "Check for Existence of emFluid 3D Grids"
				oLayout.EndRow
				oLayout.AddSpacer 0,4
			oLayout.EndGroup
			oLayout.AddGroup "Heat"
				oLayout.AddItem "emF_he_use",	"Use Heat Grid to plot Isovalues"
				if ppgShowEmFluid_he then
					oLayout.AddGroup "Rescale"
						oLayout.AddRow
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_he_rescl_srcStart",	"Source Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_he_rescl_srcEnd",		"Source End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_he_rescl_clampStart",		"Clamp Start"
							oLayout.EndGroup
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_he_rescl_dstStart",	"Target Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_he_rescl_dstEnd",		"Target End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_he_rescl_clampEnd",		"Clamp End"
							oLayout.EndGroup
						oLayout.EndRow
					oLayout.EndGroup
				end if
			oLayout.EndGroup
			oLayout.AddGroup "Waste"
				oLayout.AddItem "emF_wa_use",	"Use Waste Grid to plot Isovalues"
				if ppgShowEmFluid_wa then
					oLayout.AddGroup "Rescale"
						oLayout.AddRow
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_wa_rescl_srcStart",	"Source Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_wa_rescl_srcEnd",		"Source End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_wa_rescl_clampStart",		"Clamp Start"
							oLayout.EndGroup
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_wa_rescl_dstStart",	"Target Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_wa_rescl_dstEnd",		"Target End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_wa_rescl_clampEnd",		"Clamp End"
							oLayout.EndGroup
						oLayout.EndRow
					oLayout.EndGroup
				end if
			oLayout.EndGroup
			oLayout.AddGroup "Density"
				oLayout.AddItem "emF_de_use",	"Use Density Grid to plot Isovalues"
				if ppgShowEmFluid_de then
					oLayout.AddGroup "Rescale"
						oLayout.AddRow
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_de_rescl_srcStart",	"Source Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_de_rescl_srcEnd",		"Source End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_de_rescl_clampStart",		"Clamp Start"
							oLayout.EndGroup
							oLayout.AddGroup "", false
								set oItem = oLayout.AddItem("emF_de_rescl_dstStart",	"Target Start")
								oItem.SetAttribute siUIDecimals, 5
								set oItem = oLayout.AddItem("emF_de_rescl_dstEnd",		"Target End")
								oItem.SetAttribute siUIDecimals, 5
								oLayout.AddItem "emF_de_rescl_clampEnd",		"Clamp End"
							oLayout.EndGroup
						oLayout.EndRow
					oLayout.EndGroup
				end if
...
function emPolygonizer4_PointCloud_DefineLayout( in_ctxt )
	dim oLayout
	set oLayout = in_ctxt.Source
	myownDefineLayout	oLayout, 150, 150, 150
	emPolygonizer4_PointCloud_DefineLayout = true
end function

function emPolygonizer4_PointCloud_OnInit( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150 
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_OnClosed( )
end function
...
function emPolygonizer4_PointCloud_fpCheckA_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
...
function emPolygonizer4_PointCloud_fpCheckB_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
...
function emPolygonizer4_PointCloud_lgClothCheckIdentifier_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
...
function emPolygonizer4_PointCloud_lgClothCheckTopology_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
	Dim DataNames(1)
...
function emPolygonizer4_PointCloud_iceCheckDataPoint_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
	Dim DataNames(4)
...
function emPolygonizer4_PointCloud_iceCheckDataStrand_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
	Dim DataNames(3)
...
function emPolygonizer4_PointCloud_iceCheckDataLiquidFilaments_OnClicked( )
	Dim sMsg,sRet,flag
	' check Syntax
	Dim DataNames(8)
...
function emPolygonizer4_PointCloud_BtnShowLiquid_OnClicked( )
	Dim a
...
function emPolygonizer4_PointCloud_BtnFCurveDisplaySmall_OnClicked( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_BtnFCurveDisplayLarge_overallfade_OnClicked( )
	myownDefineLayout PPG.PPGLayout, 400, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_BtnFCurveDisplayLarge_overallprofile_OnClicked( )
	myownDefineLayout PPG.PPGLayout, 150, 400, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_use_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_emF__plotAsCubes_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_emF_he_use_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_emF_wa_use_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_emF_de_use_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_LFneighMode_OnChanged( )
	myownDefineLayout PPG.PPGLayout, 150, 150, 150
	PPG.Refresh
end function

function emPolygonizer4_PointCloud_iceLookForEmFluidGrids_OnClicked( )
	Dim sMsg,sRet,flag
	' check if the ICE data __baFluidBuffer exists
	Dim iceData
	iceData = "__baFluidBuffer"
	Dim DataNames(0)
	DataNames(0) = iceData
	sRet = checkSyntaxAndICEData("",DataNames,true)
	if sRet = "ok" then
	
		' get list of ICE attributes
		Dim x3dObj
		set x3dObj = PPG.Inspected(0).parent
		if x3dObj.type <> "pointcloud" then
			MsgBox "Error:   This property page doesn't belong to a point cloud!", siMsgInformation, "emPolygonizer4"
			exit function
		end if
		Dim attribs
		set attribs = x3dObj.ActivePrimitive.Geometry.ICEAttributes

		' check data type (must be integer)
		Dim o,dataType
		dataType = 0
		for each o in attribs
			if StrComp(o.name,iceData,1) = 0 then
				dataType = o.DataType
				exit for
			end if
		next
		if dataType<>siICENodeDataLong then
			sMsg = "Warning: the ICE data exists but it has the wrong data type."
			flag = siMsgInformation
		else
		
			' check context type (must be singleton)
			if o.ContextType<>siICENodeContextSingleton then
				sMsg = "Warning: the ICE data exists but it has the wrong context type."
				flag = siMsgInformation
			else
			
				' check structure type (must be an array)
				if o.StructureType<>siICENodeStructureArray then
					sMsg = "Warning: the ICE data exists but it has the wrong structure type."
					flag = siMsgInformation
				else

					' check if data is defined
					if not o.IsDefined then
						sMsg = "Warning: the ICE data exists but is not defined." & VbCrLf & VbCrLf & "You may have an older emFluid version (v.4.02 or below) or you need to resimulate the ICE Tree."
						flag = siMsgInformation
					else
						sMsg = "3D grids are available."
						flag = 0
					end if
		...
		sMsg = "No emFluid 3D grids were found." & VbCrLf & VbCrLf & "Cause: the point cloud has no emFluid setup."
		flag = siMsgInformation
	end if
