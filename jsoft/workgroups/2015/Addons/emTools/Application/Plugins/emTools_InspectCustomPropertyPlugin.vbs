' emTools_InspectCustomPropertyPlugin

function XSILoadPlugin( in_reg )
	in_reg.Author = "Eric Mootz"
	in_reg.Name = "emTools_InspectCustomPropertyPlugin"
	in_reg.Email = ""
	in_reg.URL = ""
	in_reg.Major = 1
	in_reg.Minor = 0

	in_reg.RegisterCommand "emTools_InspectCustomProperty","emTools_InspectCustomProperty"
...
function emTools_InspectCustomProperty_Init( in_ctxt )
	dim oCmd
	set oCmd = in_ctxt.Source
	oCmd.Description = ""
	oCmd.ReturnValue = true

	emTools_InspectCustomProperty_Init = true
end function

function emTools_InspectCustomProperty_Execute(  )
	...
	emTools_InspectCustomProperty_Execute = true
end function
